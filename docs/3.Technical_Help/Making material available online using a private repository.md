While it is cool to be able to manage and build a website from within Obsidian ([[Set Up Your Own Website|see these instructions]]), that approach requires a *public* repository that anyone might find.
